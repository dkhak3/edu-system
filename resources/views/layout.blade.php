            ...
            <div class="col-lg-2 col-md-12 col-12">
                <div class="dashboard-left">
                    ...
                    <a href="{{ url('contacts') }}" id="menuItem_contact" class="menu-item" aria-current="page">
                        <span class="menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="icon"  viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    {{-- courses --}}
                    <a href="{{ route('courses') }}"  id="courses-page" class="menu-item"
                        aria-current="page">
                        <span class="menu-icon">
